...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  final TextEditingController _supabaseUrlController = TextEditingController(text: 'https://example.supabase.co');
  final TextEditingController _supabaseKeyController = TextEditingController(text: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...');
  
  // Paramu00e8tres des seuils d'alerte
  final TextEditingController _lowStockThresholdController = TextEditingController(text: '10');
  final TextEditingController _maintenanceReminderDaysController = TextEditingController(text: '30');
  final TextEditingController _predictionConfidenceController = TextEditingController(text: '75');
  ...
  Widget _buildHeader() {
    return Column(
      ...
      children: [
        ...
        Text(
          'Configurez les paramu00e8tres de votre tableau de bord d\'administration KARHABTI',
        ...
        children: [
          Container(
            ...
            child: TabBar(
              ...
              tabs: const [
                Tab(text: 'Gu00e9nu00e9ral'),
                Tab(text: 'Base de donnu00e9es'),
  ...
  Widget _buildGeneralSettings() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const Text(
            'Pru00e9fu00e9rences de l\'interface',
            style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
          ),
          const SizedBox(height: 16),
          _buildSettingSwitch(
            'Activer les notifications',
            'Recevoir des alertes pour les u00e9vu00e9nements importants',
          ...
          _buildSettingSwitch(
            'Mode sombre',
            'Utiliser une interface sombre pour ru00e9duire la fatigue oculaire',
            _darkModeEnabled,
            (value) {
              setState(() {
          ...
          _buildSettingDropdown(
            'Langue',
            'Su00e9lectionnez la langue de l\'interface',
            _language,
            ['Franu00e7ais', 'English', 'Arabic'],
            (value) {
              setState(() {
                _language = value!;
              });
          ...
          _buildSettingDropdown(
            'Format de date',
            'Su00e9lectionnez le format de date pru00e9fu00e9ru00e9',
            _dateFormat,
          ...
          const Text(
            'Sauvegarde des donnu00e9es',
            style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
          ),
          const SizedBox(height: 16),
          _buildSettingSwitch(
            'Sauvegarde automatique',
            'Activer la sauvegarde automatique des donnu00e9es',
            _autoBackupEnabled,
            (value) {
              setState(() {
          ...
          const Divider(),
          _buildSettingDropdown(
            'Fru00e9quence de sauvegarde',
            'Su00e9lectionnez la fru00e9quence de sauvegarde automatique',
            _backupFrequency,
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  _showSnackBar('Paramu00e8tres enregistru00e9s avec succu00e8s');
                },
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSettingTextField(
            'Clu00e9 API anonyme',
            'Clu00e9 API Supabase pour les requu00eates anonymes',
          ...
          OutlinedButton.icon(
            onPressed: () {
              ...
              _showSnackBar('Test de connexion ru00e9ussi');
            },
              ...
              OutlinedButton.icon(
                onPressed: () {
                  ...
                  _showConfirmationDialog(
                    'Synchroniser la base de donnu00e9es',
                    'Voulez-vous vraiment forcer la synchronisation de la base de donnu00e9es? Cette opu00e9ration peut prendre du temps.',
                    () {
            ...
            child: ListView(
              ...
              children: [
                ListTile(
                  ...
                  subtitle: const Text('Accu00e8s complet u00e0 toutes les fonctionnalitu00e9s'),
                  trailing: IconButton(
                ...
                ListTile(
                  ...
                  subtitle: const Text('Gestion des piu00e8ces, vu00e9hicules et clients'),
                  trailing: IconButton(
                    icon: const Icon(Icons.edit),
                    onPressed: () {},
                  ),
                ...
                ListTile(
                  ...
                  subtitle: const Text('Accu00e8s aux messages et ru00e9ponses aux clients'),
                  trailing: IconButton(
                    icon: const Icon(Icons.edit),
                    onPressed: () {},
                  ),
                ...
                ListTile(
                  ...
                  subtitle: const Text('Accu00e8s en lecture aux statistiques et analyses'),
                  trailing: IconButton(
                    icon: const Icon(Icons.edit),
                    onPressed: () {},
                  ),
  ...
  Widget _buildSettingTextField(String label, String hint, TextEditingController controller, {bool isSecret = false, TextInputType keyboardType = TextInputType.text}) {
    return TextField(
  ...
  Widget _buildUserListItem(String email, String name, String role, {required bool isActive}) {
    return ListTile(
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  value: selectedRole,
                  items: ['Administrateur', 'Gestionnaire', 'Support client', 'Analyste de donnu00e9es']
