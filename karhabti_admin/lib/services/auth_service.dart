...
class AuthService {
  ...
  Future<bool> isResponsableTechnicien(String userId) async {
    try {
      ...
      return response['est_actif'] != false;
    } catch (_) {
      return false;
    }
  }
  ...
  Future<UserRole> getCurrentUserRole() async {
    ...
    if (await isAdmin(user.id)) return UserRole.admin;
    if (await isResponsableTechnicien(user.id)) {
      return UserRole.responsableTechnicien;
    }
